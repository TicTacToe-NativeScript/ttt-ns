...
function pageLoaded(args) {
  ...
  viewModel.loadGameResults()
    .then(function () {
      displayGameResult(page, 0);
    }, function (err) {
      console.dir(err);
    });
}

function displayGameResult(page, index) {
  ...
  console.dir(currentGameResult.board);
  ...
  labelDescription.text = `${currentGameResult.playerOneUsername} vs ${currentGameResult.playerTwoUsername} - ${currentGameResult.playedOn}`;
